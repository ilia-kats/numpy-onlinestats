...
public:
  OnlineStats(const nb::ndarray<nb::device::cpu> &initial) {
    ...
    ~OnlineStats() {
        delete[] m_shape;
        delete[] m_stride;
        dtype_switch([this]<typename Dtype>{delete_digests<Dtype>();});
        operator delete(m_digests);
    }

    void add(const nb::ndarray<nb::device::cpu> &arr) {
        return dtype_switch([this, &arr]<typename Dtype>{return select_add<Dtype, DTYPES>(arr);});
    }


    nb::ndarray<nb::numpy, double> quantile(double q) {
        return dtype_switch([this, q]<typename Dtype>{return quantile_impl<Dtype>(q);});
    }

};

template<>
constexpr OnlineStats::dtypes OnlineStats::dtype<float>() {return dtypes::f32;}
template<>
constexpr OnlineStats::dtypes OnlineStats::dtype<double>() {return dtypes::f64;}
template<>
constexpr OnlineStats::dtypes OnlineStats::dtype<int8_t>() {return dtypes::i8;}
template<>
constexpr OnlineStats::dtypes OnlineStats::dtype<int16_t>() {return dtypes::i16;}
template<>
constexpr OnlineStats::dtypes OnlineStats::dtype<int32_t>() {return dtypes::i32;}
template<>
constexpr OnlineStats::dtypes OnlineStats::dtype<int64_t>() {return dtypes::i64;}
template<>
constexpr OnlineStats::dtypes OnlineStats::dtype<uint8_t>() {return dtypes::u8;}
template<>
constexpr OnlineStats::dtypes OnlineStats::dtype<uint16_t>() {return dtypes::u16;}
template<>
constexpr OnlineStats::dtypes OnlineStats::dtype<uint32_t>() {return dtypes::u32;}
template<>
constexpr OnlineStats::dtypes OnlineStats::dtype<uint64_t>() {return dtypes::u64;}
